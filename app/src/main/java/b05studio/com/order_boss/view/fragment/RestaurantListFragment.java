...
public class RestaurantListFragment extends Fragment {
    ...
    private void initButton(View rootView) {
        ...
        Button oneThirdKilo = (Button)rootView.findViewById(R.id.restaurantList300m);
        oneThirdKilo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                currentDistance = "300m";
            }
        });
        Button halfKilo = (Button)rootView.findViewById(R.id.restaurantList500m);
        halfKilo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                currentDistance = "500m";
            }
        });
        Button oneKilo = (Button)rootView.findViewById(R.id.restaurantList1km);
        ...
        Button oneHalfKilo = (Button)rootView.findViewById(R.id.restaurantList1_5km);
        oneHalfKilo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                currentDistance = "1.5km";
            }
        });
        Button threeKilo = (Button)rootView.findViewById(R.id.restaurantList3km);
        ...
        Button fiveKilo = (Button)rootView.findViewById(R.id.restaurantList5km);
